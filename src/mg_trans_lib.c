...
/* allocate memory */
malloc_multi (1,1,sizeof(float), nx+2,0,0, &uhelp);
malloc_multi (1,1,sizeof(float), mx+2,0,0, &vhelp);
...
/* free memory */
free_multi (1,1,sizeof(float), nx+2,0,0, &uhelp);
free_multi (1,1,sizeof(float), mx+2,0,0, &vhelp);
return;
} 
